...
//        mBorderThickness = type.getDimensionPixelSize(R.styleable.circleimageview_border_thickness, 0);
//        mBorderOutsideColor = type.getColor(R.styleable.circleimageview_border_outside_color, defaultColor);
//        mBorderInsideColor = type.getColor(R.styleable.circleimageview_border_inside_color, defaultColor);
    }
